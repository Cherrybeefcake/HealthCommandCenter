...
- Launch screen: generated by Xcode
- App icon: no final icon asset is included yet; add an `AppIcon` asset catalog before archiving for TestFlight
...
- Add an `AppIcon` asset catalog before archiving. Final brand artwork can come later, but TestFlight/App Store packaging needs a valid icon set.
